...
<div id="wrapper">
    ...
    <div class="container-fluid">
        ...
        <div id="content-wrapper" class="float-sm-left">


            <form action="/user/edit" method="post">
                <div class="form-group mx-sm-5 pt-1">
                    <label for="exampleInputUserName1">Użytkownik</label>
                ...
                <div class="form-group mx-sm-5">
                    ...
                    <small id="emailHelp" class="form-text text-muted">Wpisz adres email</small>
                </div>
                <div class="form-group mx-sm-5">
                ...
                <button type="submit" class="btn btn-secondary mx-sm-5">Aktualizuj dane użytkownika</button>
            </form>
